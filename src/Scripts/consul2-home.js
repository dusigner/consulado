...
require('components/vitrine-personalizada');
...
Nitro.controller('home', ['chaordic', 'slider-banner', 'lead-newsletter', 'vitrine-personalizada', /* 'tabs-consumidor', 'tabs-descontos', */ 'linkDoubleClick', 'chatHome', 'shelfCategoryHome' /*'counter', 'datalayer_track'*/], function (chaordic) {
	var self = this,
