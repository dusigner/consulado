...
Nitro.module('calculadorabtu', function() {
	...
	var updateRange = function(res) {
		...
		return range
			.map(function(btu) {
				return (
					(window.jsnomeLoja === 'consulqa'
						? '&fq=specificationFilter_77:'
						: '&fq=specificationFilter_814:') +
					btu +
					' BTUs/h'
				);
			})
