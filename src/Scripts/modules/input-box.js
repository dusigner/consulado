...
Nitro.module('input-box', function() {
	...
	$(window).click(function() {
		...
		$inputSelect.find('.input-box-dropdown-options').slideUp(400, function() {
			$inputSelect.removeClass('active -active');
		});
	});
	...
	$(document).on('click', '.input-box-dropdown-options > li', function() {
		...
		$this
			.parents('.input-box-dropdown')
			.find('.input-box-dropdown-toggle')
			.html(value);
