...
var ModalGae = {
	$body: $('body'),
	template:
		'<div class="text-center modal-gae__body">' +
	...
	requestTerms: function(data, cb) {
		var steps = {
				stepOne:
					'<p class="modal-gae__text no-margin">Deseja solicitar os termos do <br /> seguro de garantia estendida?</p>' +
					'<p class="modal-gae__ticket">' +
					data.order +
					'</p>' +
					...
					'</div>',
				stepTwo:
					'<p class="modal-gae__text">A sua solicitação foi realizada com sucesso! <br /> Enviaremos os termos do seguro de garantia estendida no e-mail cadastrado na loja.</p>'
			},
			templateData = {
				title: 'TERMOS DA GARANTIA ESTENDIDA',
				content:
					'<div class="modal-gae__request-terms step step-one current">' +
					steps.stepOne +
					'</div>' +
					'<div class="modal-gae__request-terms step step-two">' +
					steps.stepTwo +
					'</div>'
			};
	...
	requestCancel: function(data, cb) {
		var steps = {
				stepOne:
					'<p class="modal-gae__text">Deseja solicitar o cancelamento do <br /> seguro de garantia estendida?</p>' +
					'<div class="modal-gae__ctas">' +
					...
					'</div>',
				stepTwo:
					'<p class="modal-gae__text">A sua solicitação foi realizada com sucesso! <br /> O pedido de cancelamento será analisado e respondido no e-mail cadastrado na loja.</p>'
			},
			templateData = {
				title: 'CANCELAR GARANTIA ESTENDIDA',
				content:
					'<div class="modal-gae__request-cancel step step-one current">' +
					steps.stepOne +
					'</div>' +
					'<div class="modal-gae__request-cancel step step-two">' +
					steps.stepTwo +
					'</div>'
			};
