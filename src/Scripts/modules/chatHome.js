...
Nitro.module('chatHome', function() {
	...
	this.chatHome = function() {
		...
		function redirect(e) {
			...
			modal.innerHTML =
				'<p style="font-family:consul,Helvetica Neue,Helvetica,Arial,sans-serif">Você será direcionado para o Portal de Atendimento Consul.</p> <p style="font-family:consul,Helvetica Neue,Helvetica,Arial,sans-serif">Por favor, aguarde... (<span class="counter">5</span>)</p>';
		...
		function redirectPecas(e) {
			...
			var interval = window.setInterval(function() {
				if (i === 0) {
					...
					document.getElementById('btn-close-chat').click();
					window.location =
						'http://consul.custhelp.com/app/chat/chat_launch?c=4741,4742,4745,4790&s=others-2';
					return false;
				}
				i--;
				counter.innerHTML = i;
