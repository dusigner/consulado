...
jQuery( function () {
	...
	//quando inciar, scrolla a pagina pra calculadora ficar no topo da pagina
	jQuery( '.introducao .btn-init' ).on( 'click', function(){
		var top = jQuery(window).width() <= 768 ? (window.parent.jQuery('.page-calculadora-btu__banner').offset().top - window.parent.jQuery('header').height() + 25) : (window.parent.jQuery('.page-calculadora-btu__banner').offset().top);
