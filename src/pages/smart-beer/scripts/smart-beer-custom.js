...
var animation_App = function () {
    ...
    var wrapperWidth = $(".sb-app .wrapper").width(),
        ...
        section = $(".sb-app"),
        section1Height = $(".sb-app .wrapper").height(),
    ...
    t2_animation
        // APP STEEP #01
        .to(sb_app_steep1, 0.5, { autoAlpha: 0 })

        // APP STEEP #02
        .to(sb_app_steep2, 0.5, { autoAlpha: 1 })
        .to(as_02_01, 0.5, { autoAlpha: 1 })
        .to(as_02_02, 0.5, { autoAlpha: 1 })
        .to(as_02_03, 0.5, { autoAlpha: 1 })
        .to(as_02_04, 0.5, { autoAlpha: 1 })
        .to(sb_app_steep2, 0.5, { autoAlpha: 0 })

        // APP STEEP #03
        .to(sb_app_steep3, 0.5, { autoAlpha: 1 })
        .to(as_03_01, 0.5, { autoAlpha: 1 })
        .to(as_03_02, 0.5, { autoAlpha: 1 })
        .to(as_03_03, 0.5, { autoAlpha: 1 })
        .to(sb_app_steep3, 0.5, { autoAlpha: 0 })

        // APP STEEP #04
        .to(sb_app_steep4, 0.5, { autoAlpha: 1 })
        .to(as_04_01, 0.5, { autoAlpha: 1 })
        .to(as_04_01, 0.5, { autoAlpha: 0 })

        //End animation
        .to(app_smartbeer, 0.5, { autoAlpha: 0 })
        .to(app_smartbeer, 0, { x: 500 })

        .to(mockup_mobile, 0.5, { right: 400 })
        .to(app_smartbeer, 0.5, { autoAlpha: 1, left: 500 })
...
var animation_Features = function () {
    ...
    var wrapperWidth = $(".sb-features .wrapper").width(),
        ...
        section = $(".sb-features"),
        section1Height = $(".sb-features .wrapper").height(),
    ...
    t3_animation
        ...
        .to(sb_f_massage, 0.5, { autoAlpha: 1 })
        .to(f_01_01, 0.5, { autoAlpha: 1 })
        .to(f_01_02, 0.5, { autoAlpha: 1 })
        .to(f_01_03, 0.5, { autoAlpha: 1 })
        .to(f_01_04, 0.5, { autoAlpha: 1 })
        .to(sb_f_massage, 0.5, { autoAlpha: 0 })
        .to(sb_features_steep1, 0.5, { autoAlpha: 0 })

        // APP STEEP #02
        .to(sb_features_steep2, 0.5, { autoAlpha: 1 })
        .to(f_02_01, 0.5, { autoAlpha: 1 })
        .to(f_02_02, 0.5, { autoAlpha: 1 })
        .to(sb_features_steep2, 0.5, { autoAlpha: 0 })

        // APP STEEP #03
        .to(sb_features_steep3, 0.5, { autoAlpha: 1 })
        .to(f_03_01, 0.5, { autoAlpha: 1 })
        .to(f_03_02, 0.5, { autoAlpha: 1 })
        .to(f_03_03, 0.5, { autoAlpha: 1 })
        .to(f_03_04, 0.5, { autoAlpha: 1 })
        .to(sb_features_steep3, 0.5, { autoAlpha: 0 })

        // APP STEEP #04
        .to(sb_features_steep4, 0.5, { autoAlpha: 1 })
        .to(f_04_01, 0.5, { autoAlpha: 1 })

        //End animation
        .to(longnecks, 0.5, { autoAlpha: 0 })
        .to(garrafas, 0.5, { autoAlpha: 1 })
        .to(garrafas, 0.5, { autoAlpha: 0 })
        .to(latas, 0.5, { autoAlpha: 1 })
