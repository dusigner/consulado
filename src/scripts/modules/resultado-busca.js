...
Nitro.module('resultado-busca', function () {
	...
	if( $.isEmptyObject(params) || !('fq' in params) ) {
		...
		switch( params.fq ) {
			...
			case 'H:231' : $('.banner-dormir-100 .box-banner').show(); break;

			case 'H:232' : $('.banner-dormir-200 .box-banner').show(); break;

			case 'H:233' : $('.banner-dormir-400 .box-banner').show(); break;

			case 'H:234' : $('.banner-dormir-800 .box-banner').show(); break;

			default: $('.banner-default .box-banner').show();
		}
