	...
	var cookieIPI = window.getCookie('IPI') || '',
		...
		bannerTemplate = '<div class="box-banner">' +
							'<a href="http://api-public-p3-eu1.advisor.smartfocus.com/api-public/3.0/click/1?a=3d025fc8-2cab-4670-87d7-6ff64cb4e869&e=10897&uc={0}&l=en&cacheTimeout=0&channel=web&pos=default">' +
								'<img src="http://renderer-p3-eu1.advisor.smartfocus.com/api-public/3.0/personaliseemail?a=3d025fc8-2cab-4670-87d7-6ff64cb4e869&uc={0}&e=10897&f=gif&l=en&h=340&w=1900&cacheTimeout=0&channel=web&pos=default" height="170" width="950" alt="SmartFocus Personalisation" />' +
							'</a>' +
						'</div>';
